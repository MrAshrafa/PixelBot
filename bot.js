...
${predix}server • لعرض معلومات سيرفر
${prefix}bot • لعرض معلومات بوت 
${prefix}image • ليعرض صورا سيرفر
${prefix}ping • يعرض لك بنق بوت
${prefix}invites • يعرض كم انت ضايف
${prefix}topinvite • يضهر لك اكثر الشخاص يضيفو
$}prefix}roles • يضهر لك رتب 
${prefix}roles-n • يضهر لك رتب بل ترتيب
${prefix}dt • يضهر لك وقت وتاريخ
${prefix}mb • يضهر لك حالة الاعضاء
==========
اوامر الادارة
==========
...
${prefix}mute • لعطاء شخص ميوت كتابي
${prefix}unmute • لفك ميوت عن شخص
${prefix}dac • حذف جميع رومات سيرفر
${predix}dar • حذف جميع رتب سيرفر
${prefix}role • لعطاء شخص رتبة
${prefix}role {bot,all}• لعطاء جميع او بوتات رتبة 
${prefix}roleremove • لسحب رتبة من شخص
${prefix}closeroom • لغلق روم 
${prefix}openroom • لفتح روم
==========
${prefix}support • يعرض لك سيرفر بوت
${prefix}inv • يعرض رابك انفايت بوت
==========
شكرا لستعمالك بوت :heart:
==========
       **  `)
...
client.on('message', message => {
  ...
  .setColor("RANDOM")
  .addField("Done" , " تم رساله في خاصك")
 ...
 client.on('message', message => { 
    ...
    .setFooter(`PixelBot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
